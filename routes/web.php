...
Route::group(['prefix' => '/'], function () {
    ...
    Route::get('/home', 'Backend\DashboardController@index')->name('home.dashboard');
});

Route::group(['prefix' => 'branches'], function () {
    Route::get('/', 'Backend\BranchController@index')->name('branch.index');
    ...
    Route::get('{id}/edit', 'Backend\BranchController@edit')->name('branch.edit');
    Route::post('update', 'Backend\BranchController@update')->name('branch.update');
    Route::post('delete', 'Backend\BranchController@delete')->name('branch.delete');
    Route::get('dtIndex.json', 'Backend\BranchController@dtIndex')->name('branch.dtIndex');
});
...
Route::group(['prefix' => 'users'], function () {
    ...
    Route::get('dtIndex.json', 'Backend\UserController@dtIndex')->name('user.dtIndex');
    Route::get('{id}/permission', 'Backend\UserController@permission')->name('user.permission');
    Route::post('store-permission', 'Backend\UserController@storePermission')->name('user.store.permission');
    Route::post('delete-permission', 'Backend\UserController@deletePermission')->name('user.delete.permission');
    Route::get('dtIndexPermission', 'Backend\UserController@dtIndexPermission')->name('user.dtIndex.permission');
    Route::get('{id}/role', 'Backend\UserController@role')->name('user.role');
    Route::post('store-role', 'Backend\UserController@storeRole')->name('user.store.role');
    Route::post('delete-role', 'Backend\UserController@deleteRole')->name('user.delete.role');
    Route::get('dtIndexRole', 'Backend\UserController@dtIndexRole')->name('user.dtIndex.role');
    Route::post('activate-or-inactivate', 'Backend\UserController@activateOrInactivate')->name('user.activateOrInactivate');
});

Route::group(['prefix' => 'permissions'], function () {
	Route::get('/', 'Backend\PermissionController@index')->name('permission.index');
    Route::get('create', 'Backend\PermissionController@create')->name('permission.create');
    Route::post('store', 'Backend\PermissionController@store')->name('permission.store');
    Route::get('{id}/edit', 'Backend\PermissionController@edit')->name('permission.edit');
    Route::post('update', 'Backend\PermissionController@update')->name('permission.update');
    Route::post('delete', 'Backend\PermissionController@delete')->name('permission.delete');
    Route::get('dtIndex', 'Backend\PermissionController@dtIndex')->name('permission.dtIndex');
});

Route::group(['prefix' => 'roles'], function () {
	Route::get('/', 'Backend\RoleController@index')->name('role.index');
    Route::get('create', 'Backend\RoleController@create')->name('role.create');
    Route::post('store', 'Backend\RoleController@store')->name('role.store');
    Route::get('{id}/edit', 'Backend\RoleController@edit')->name('role.edit');
    Route::post('update', 'Backend\RoleController@update')->name('role.update');
    Route::post('delete', 'Backend\RoleController@delete')->name('role.delete');
    Route::get('dtIndex', 'Backend\RoleController@dtIndex')->name('role.dtIndex');
});
...
/// ADMIN TEMPLATE PLEASE IGNORE THIS ///
Route::get('/adminBSB-example/dashboard', function () {
    return view('adminBSB-example/dashboard.index');
})->name('adminBSB.dashboard.index');

Route::group(['prefix' => 'adminBSB-example', /*'middleware' => 'auth'*/], function () {
    // TYPOGRAPHY
