        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <a href="{{ route('permission.index') }}" class="btn bg-blue-grey btn-circle waves-effect waves-circle waves-float">
                    ...
                    <div class="body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('permission.update') }}" enctype="multipart/form-data" id="form-input">
                            <div class="row">
                                <div class="col-lg-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-line @error('name') error focused @enderror">
                                            <input type="text" id="" class="form-control" name="name" placeholder="Enter name" required value="{{ $permission->name }}">
                                        </div>
                                        @error('name')
