            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 align-right">
                                <h2>
                                    <a href="{{ route('permission.create') }}" class="btn btn-primary btn-sm waves-effect text-right">
                    ...
                    <div class="body">
                        ...
                        <form id="delete-form" action="{{ route('permission.delete') }}" method="POST" style="display: none;">
                            @csrf
