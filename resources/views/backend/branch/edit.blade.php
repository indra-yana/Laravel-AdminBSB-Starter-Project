            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('branch.update') }}" enctype="multipart/form-data" id="form-input">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-line @error('name') error focused @enderror">
                                            <input type="text" id="" class="form-control" name="name" placeholder="Enter name" required value="{{ $branch->name }}">
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line @error('code') error focused @enderror">
                                            <input type="text" class="form-control" name="code" placeholder="Enter branch code" value="{{ $branch->code }}" required autocomplete="off">
                                        </div>
                                        @error('code') 
                                            <label class="error">{{ $message }}</label>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-line @error('description') error focused @enderror">
                                            <textarea rows="3" class="form-control no-resize" name="description" placeholder="Enter description or some notes">{{ $branch->description }}</textarea>
                                        </div>
                                        @error('description')
                                            <label class="error">{{ $message }}</label>
                                        @enderror
